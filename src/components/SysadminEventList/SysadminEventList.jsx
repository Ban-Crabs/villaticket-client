// SysadminEventList
import style from "./SysadminEventList.module.scss";

import eventImg from '../../assets/warriors-stadium.jpg'
import nextSvg from '../../assets/next.svg'

const SysadminEventList = () => {
    return (
        <>
            <div className={style["heading"]}>
                <h1>Your Events</h1>
                <div className={style["event-card-info-btn"]}>
                    <button className={style["add-event"]} type="submit">Add Event</button>
                </div>
            </div>
                            ...
                            <div className={style["event-card-info"]}>
                                ...
                                <div className={style["event-btn-container"]}>
                                    ...
                                    <div className={style["container1"]}>
                                        <div className={style["event-card-info-btn"]}>
                                            <button className={style["disable-event"]} type="submit">Disable</button>
                                        </div>

                                        <div className={style["event-card-info-btn"]}>
                                            <button className={style["edit-event"]} type="submit">Edit</button>
                                        </div>
                                    ...
                                    <div className={style["container1"]}>
                                        <div className={style["event-card-info-btn"]}>
                                            <button className={style["scanner-event"]} type="submit">Scanner</button>
                                        </div>

                                        <div className={style["event-card-info-btn"]}>
                                            <button className={style["analytics-event"]} type="submit">Analytics</button>
                                        </div>
                                    </div>
...
export default SysadminEventList;